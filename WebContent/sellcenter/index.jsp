  ...
  <TBODY>
      ...
      <TD align=middle background=css.files/top.gif colSpan=3 height=50>
        <TABLE width="100%">
          <TBODY>
            ...
            <span style="font-weight: bold;font-size: 25px;">校园二手交易系统卖家中心主界面</span>  
              　
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         ...
         欢迎${user.username }&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <A href="."><FONT  color=#ffffff>返回首页</FONT></A>
              </B></FONT> </TD>
            </TR>
          </TBODY>
        </TABLE>
    ...
    <TR>
      <TD id=frm vAlign=center noWrap align=middle height="100%">
        <IFRAME style="Z-INDEX: 2; VISIBILITY: inherit; WIDTH: 200px; HEIGHT: 100%" name=rijcm src="sellcenter/menu.jsp" frameBorder=0 scrolling=no></IFRAME>
      ...
      <TD width="100%">
        <IFRAME id=main  style="Z-INDEX: 1; VISIBILITY: inherit; WIDTH: 100%; HEIGHT: 100%"  name=main src="sellcenter/web.jsp" frameBorder=0  scrolling=yes></IFRAME>
      </TD>
    </TR>
  </TBODY>
</TABLE>
